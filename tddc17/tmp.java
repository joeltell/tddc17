...
if(bump)
{
    switch (agent_direction) {
    case MyAgentState.NORTH:
    if(world[agent_x_position+1][agent_y_position] != WALL && world[agent_x_position+1][agent_y_position] == UNKNOWN )
    {
    ...
    else
    {
      ...
      break;
    case MyAgentState.EAST:
    if(world[agent_x_position][agent_y_position+1] != WALL && world[agent_x_position][agent_y_position+1] == UNKNOWN )
    {
      Q.add(ACTION_TURN_RIGHT);
    }
